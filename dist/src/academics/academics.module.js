...
exports.AcademicsModule = AcademicsModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [academics_controller_1.AcademicsController, exams_controller_1.ExamsController],
        providers: [academics_service_1.AcademicsService, exams_service_1.ExamsService],
    })
], AcademicsModule);
